...
##### if you are using unity catalog, upload it to a volumn then replace CERTIFICATE_PATH with following reference
###### e.g. CERTIFICATE_PATH = "/Volumes/your_catalog/your_schema/your_volume/certificate.pem"  # Path to certificate in Unity Catalog volume
